...
présentation passe à \textbf{44 diapositives} : le diagramme de classes en 19,
et \textbf{sept diapositives de captures} (slides 34 à 40) qui reprennent les
écrans de l'application dans l'ordre du chapitre 4 du rapport. Tout ce qui suit
est décalé --- le modèle en étoile devient la 20, la conclusion la 42, la
clôture la 44. Les numéros de ce document sont déjà à jour.
\end{corrige}
...
% =====================================================================
\section*{Partie 05 --- Intelligence artificielle et démonstration (slides 30 à 40)}
...
\subsection*{Slides 34 à 40 --- Les écrans, un par un}

Ces sept diapositives reprennent \textbf{les mêmes interfaces, dans le même
ordre que le chapitre 4 du rapport}. Si la démonstration en direct échoue, elles
suffisent à tout montrer.

\paragraph{Slide 34 --- Authentification.}
...
et c'est lui qui conditionne tout le reste : le menu affiché, et surtout les
pages autorisées.

\paragraph{Slide 35 --- Gestion des agences.}
Le référentiel du réseau. L'administrateur crée une agence avec son nom et son
adresse, consulte la liste avec le district, et peut supprimer une ligne.
Chaque écriture est inscrite au journal d'audit --- c'est exactement ce qui
manquait aux fichiers Excel de départ.

\paragraph{Slide 36 --- Gestion des employés.}
Le formulaire crée l'employé \textbf{et} son compte de connexion, avec son rôle
et son agence de rattachement. En dessous, les filtres et la liste. Le rôle
affiché --- gestionnaire, conseiller, hors commercial --- n'est pas stocké tel
quel : il est déduit des données de l'employé.

\paragraph{Slide 37 --- Portefeuille clients.}
Consultation et recherche du portefeuille, et affectation de chaque client à un
gestionnaire. C'est ce rattachement qui permettra, côté décisionnel, d'analyser
la production par gestionnaire.

\paragraph{Slide 38 --- Objectifs commerciaux.}
La production commerciale : comptes ouverts, crédits et épargne, par agence et
par gestionnaire. L'écran est en consultation seule --- ces données viennent du
système de gestion, elles ne sont pas saisies ici. C'est la même table qui
alimente le rapport Power BI.

\paragraph{Slide 39 --- Pointage des employés.}
Les cartes de synthèse en haut --- présents, retards, absents, taux de
présence ---, puis le pointage du jour avec ses deux boutons, et le formulaire
de saisie manuelle réservé à l'administrateur. Le point important :
\textbf{le statut est calculé par le serveur}, au-delà de neuf heures c'est un
retard. Il n'est jamais envoyé par le formulaire, donc on ne peut pas se
déclarer présent en trichant.

\paragraph{Slide 40 --- Tableau de bord embarqué.}
La synthèse dans l'application : les indicateurs, le bandeau des actions
requises --- qui dépend du rôle --- et les graphiques, calculés à l'affichage à
partir de la base. C'est la restitution \textbf{en temps réel}, par opposition
au rapport Power BI, dont les données sont importées et rafraîchies à la
demande. Les deux sont complémentaires : c'est une question fréquente.

\begin{coeur}
\textbf{Le fil à tenir sur ces sept écrans} : on part de la porte
d'entrée, on descend dans le référentiel, on arrive à l'activité quotidienne, et
on termine par la synthèse. C'est la même progression que le rapport, et c'est
ce qui montre que l'application est un tout, pas une collection d'écrans.
\end{coeur}

\begin{note}
\small Ne pas commenter chaque bouton : une phrase par écran suffit, celle qui
est déjà sous la capture. Les captures sont là pour \textbf{soutenir} la
démonstration en direct, ou la remplacer si la base ne répond pas.
\end{note}

% =====================================================================
\section*{Partie 06 --- Conclusion et perspectives (slides 41 à 44)}

\subsection*{Slide 42 --- Conclusion}
...
\subsection*{Slide 43 --- Perspectives}
