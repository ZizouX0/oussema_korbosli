...
% =====================================================================
\section*{Partie 03 --- Conception et architecture (slides 15 à 19)}
...
\subsection*{Slide 19 --- Modèle décisionnel en étoile}
...
% =====================================================================
\section*{Partie 04 --- Volet décisionnel et réalisation (slides 20 à 28)}

\subsection*{Slide 21 --- Chaîne ETL en Python : cinq étapes}
...
\subsection*{Slide 22 --- Datamart obtenu sur les données réelles}
...
\subsection*{Slide 23 --- Intégration du modèle dans Power BI}
...
\subsection*{Slides 24 à 27 --- Tableaux de bord}
...
\subsection*{Slide 28 --- Réalisation et environnement technique}
...
% =====================================================================
\section*{Partie 05 --- Intelligence artificielle et démonstration (slides 29 à 32)}

\subsection*{Slide 30 --- Zoom technique : segmentation par K-Means}
...
\subsection*{Slide 31 --- Résultats de la segmentation}
...
\subsection*{Slide 32 --- Démonstration}
...
% =====================================================================
\section*{Partie 06 --- Conclusion et perspectives (slides 33 à 36)}

\subsection*{Slide 34 --- Conclusion}
...
\subsection*{Slide 35 --- Perspectives}
...
\hline
19 & entourée de \textbf{quatre} dimensions & \textbf{deux} dimensions : \texttt{dim\_agence} et \texttt{dim\_gestionnaire}\\
\hline
21 & \textbf{45} agences consolidées & \textbf{49} entités du réseau consolidées\\
\hline
30 & silhouette \textbf{0,736}, Davies-Bouldin \textbf{0,350} & silhouette \textbf{0,604}, Davies-Bouldin \textbf{0,709} ; DBSCAN a un meilleur Davies-Bouldin\\
\hline
31 & \textbf{7} grandes / \textbf{16} moyennes / \textbf{22} petites & \textbf{34} d'exploitation / \textbf{6} de production sans portefeuille / \textbf{8} sans activité\\
\hline
\end{tabularx}
