    ...
    <main class="main-wrapper">
        <div class="container">
            ...
            <div class="page-header fade-up">
                ...
                <p>Suivi des objectifs par agence et gestionnaire — Total : ${totalObjectifs}</p>
            </div>

            <!-- FILTER -->
            <div class="form-card fade-up" style="margin-bottom:1.5rem;">
                <form method="get" action="${pageContext.request.contextPath}/objectifs-btk">
                    <div style="display:flex; gap:1rem; flex-wrap:wrap; align-items:flex-end;">
                        ...
                        <a href="${pageContext.request.contextPath}/objectifs-btk" class="btn btn-outline">Tout afficher</a>
                    </div>
                </form>
            </div>
                            ...
                            <table>
                                ...
                                <c:forEach var="o" items="${objectifs}">
                                    <tr>
                                        ...
                                        <td><span class="status status-approuvee">${o.situationAdministrative}</span></td>
