...
% ---------- HEADER ----------
\noindent
\begin{minipage}[c]{0.30\textwidth}\includegraphics[width=3.1cm]{logo_esb.png}\end{minipage}
\hfill
...
\end{minipage}
\hfill
\begin{minipage}[c]{0.18\textwidth}\raggedleft\includegraphics[width=1.7cm]{logo_btk.png}\end{minipage}
...
\vspace{3pt}
{\footnotesize
\textbf{Étudiant :} Oussema Korbosli \;\textbar\; \textbf{Encadrant académique :} M. ABIDI Heni
\;\textbar\; \textbf{Maître de stage :} M. ELMOULA Melek Aziz (Data Scientist)\\
