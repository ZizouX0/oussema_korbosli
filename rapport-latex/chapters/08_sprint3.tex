...
Développer l'\texttt{ObjectifServlet}/\texttt{ObjectifService} (page
\texttt{objectifs.jsp}) et le \texttt{BObjectifServlet}/\texttt{BObjectifService}
(page \texttt{objectifs-btk.jsp}) sur l'entité \texttt{Objectif} ; restituer
comptes, crédits et épargne par agence.\\
\bottomrule
\end{tabularx}
\end{table}
...
\section*{Conclusion}
Ce sprint a complété la gestion commerciale : les clients et les objectifs.
