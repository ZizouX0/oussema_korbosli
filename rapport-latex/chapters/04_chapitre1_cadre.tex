...
\needspace{5.4cm}%  phrase + fig:logo_btk sur la même page
...
accompagne aussi bien les particuliers que les entreprises. La
figure~\ref{fig:logo_btk} reproduit son logo institutionnel.
...
\begin{tabularx}{\textwidth}{|>{\bfseries\RaggedRight}p{4.1cm}|X|p{1.9cm}|}
\hline
...
\needspace{5.7cm}%  phrase + fig:gantt sur la même page
