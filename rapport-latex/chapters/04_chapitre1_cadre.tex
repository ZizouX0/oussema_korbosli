...
d'incréments. Le tableau~\ref{tab:classique_agile} oppose les deux familles.
...
\textbf{Scrum} est un cadre agile de \emph{développement logiciel} : il organise le
travail en \emph{sprints}, avec des rôles et des cérémonies, et vise la livraison
d'incréments fonctionnels. \textbf{CRISP-DM} (\emph{Cross-Industry Standard Process
...
CRISP-DM se décompose en six phases, susceptibles d'être rejouées en cycles. Le
