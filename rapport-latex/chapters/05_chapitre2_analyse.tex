...
réparties entre le développement de l'application, la base de données et le volet
décisionnel. Le tableau~\ref{tab:env_technique} en récapitule les principales et
précise le rôle de chacune.
