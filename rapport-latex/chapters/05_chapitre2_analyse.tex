...
On y distingue les trois acteurs du tableau~\ref{tab:acteurs} et les treize cas
d'utilisation du système. Le cas \emph{S'authentifier} est commun à tous : chacun
des douze autres cas lui est relié par une relation
\texttt{\guillemotleft include\guillemotright}, l'accès aux fonctionnalités exigeant une
authentification préalable ; c'est pourquoi aucun acteur ne lui est directement
associé. L'\textbf{administrateur} concentre les cas de gestion, de validation et
de supervision du volet décisionnel (\emph{Gérer les rôles et les droits d'accès},
\emph{Alimenter le datamart}, \emph{Segmenter les agences}) ; le \textbf{directeur
commercial} soumet les demandes, suit les objectifs et valide, conformément au
tableau~\ref{tab:acteurs}, les seules demandes de modification des données des
employés --- restriction portée par la note attachée au cas \emph{Valider une
demande} ; l'\textbf{utilisateur} se limite au pointage, aux notifications et aux
