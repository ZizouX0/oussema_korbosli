...
La figure~\ref{fig:ui_pointage} présente les interfaces de pointage et de gestion
des demandes. \emph{Les captures d'écran réelles seront insérées à cet emplacement.}

\begin{figure}[htbp]
  \centering
  \fbox{\parbox[c][3.6cm][c]{0.8\textwidth}{\centering\itshape Capture à insérer
  -- pointage et workflows de demandes}}
  \caption{Interfaces du pointage et des demandes}
