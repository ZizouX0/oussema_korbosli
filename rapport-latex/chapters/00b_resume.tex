% ============================ RÉSUMÉ / ABSTRACT =======================
\thispagestyle{empty}
% Interligne resserré pour que Résumé + Abstract tiennent sur une seule page.
{\setstretch{1.25}
\vspace*{0.8cm}

{\large\bfseries\color{black} Résumé}\\[0.3cm]
\noindent
...
{\large\bfseries\color{black} Abstract}\\[0.3cm]
\noindent
