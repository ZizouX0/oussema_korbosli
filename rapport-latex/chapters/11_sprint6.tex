...
production, la segmentation présentée dans ce chapitre est \textbf{illustrée sur un
jeu de données représentatif} du réseau, généré par la chaîne ETL pour reproduire
la structure et les ordres de grandeur des agences ; le pipeline bascule
...
\section*{Conclusion}
Après détermination du nombre optimal de clusters et comparaison de plusieurs
modèles, le K-Means a fait émerger trois segments d'agences cohérents et
